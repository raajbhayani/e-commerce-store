...
const Autocomplete = props => {
  ...
  return (
    <div className='autocomplete-container col-8 col-xl-8 col-lg-12 col-md-12 col-sm-12' ref={container}>
      <input
        type='text'
        onChange={e => {
          onChange(e)
        ...
        value={userInput}
        className={`autocomplete-search col-8 col-xl-8 col-lg-12 col-md-12 col-sm-12 ${props.className ? props.className : ''}`}
