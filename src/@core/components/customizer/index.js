...
const Customizer = props => {
  ...
  const renderFooterTypeRadio = () => {
    ...
    return footerTypeArr.map((radio, index) => {
      ...
      return (
        <div key={radio.label + index} className={classnames('form-check', { 'mb-2 me-1': marginCondition })}>
          <Input
            type='radio'
          ...
          />
          <Label className='form-check-label' htmlFor={`footer-${radio.name}`}>
            {radio.label}
          </Label>
        </div>
      )
          ...
          <div className='mb-2'>
            ...
            <div className='d-flex'>
              <div className='form-check me-1'>
                ...
                />
                <Label className='form-check-label' htmlFor='full-width'>
                  Full Width
                </Label>
              </div>
              <div className='form-check'>
                ...
                />
                <Label className='form-check-label' htmlFor='boxed'>
                  Boxed
                </Label>
              </div>
            </div>
          ...
          <div className='mb-2'>
            <div className='d-flex align-items-center'>
              <div className='form-check me-1'>
                ...
                />
                <Label className='form-check-label' htmlFor='vertical-layout'>
                  Vertical
                </Label>
              </div>
              <div className='form-check'>
                ...
                />
                <Label className='form-check-label' htmlFor='horizontal-layout'>
                  Horizontal
                </Label>
              </div>
            </div>
